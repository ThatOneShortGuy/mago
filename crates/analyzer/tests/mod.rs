...
test_case!(parameter_variable_derived_types);
test_case!(parameter_variable_nested_types);
test_case!(parameter_variable_dependent_parameters);
test_case!(parameter_variable_invocation_forms);
test_case!(parameter_variable_complex_combinations);
test_case!(parameter_variable_direct_parameter_types);
test_case!(parameter_variable_return_bodies);
test_case!(parameter_variable_callable_scopes);
test_case!(parameter_variable_partial_mixed_bindings);
test_case!(parameter_variable_split_unpacking);
test_case!(parameter_variable_optional_unpack_defaults);
test_case!(parameter_variable_magic_methods);
test_case!(parameter_variable_intersection_combinations);
test_case!(derived_type_intersection_combinations);
...
test_case!(callable_string_rejects_class_constants);
...
test_case!(property_hook_asymmetric_write_tracking);
test_case!(property_hook_generic_write_tracking);
test_case!(property_hook_symmetric_write_tracking);
test_case!(property_hook_backing_store_write);
...
test_case!(issue_2231);
test_case!(issue_2232);
...
test_case!(issue_2303);
test_case!(issue_2304);
test_case!(issue_2305);
test_case!(issue_2307);
test_case!(issue_2308);
test_case!(issue_2309);
test_case!(issue_2311);
test_case!(issue_2312);
